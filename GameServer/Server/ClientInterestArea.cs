...
namespace Space.Server
{
    ...
    public class ClientInterestArea : InterestArea
    {
        ...
        //private readonly Dictionary<Item, IDisposable> positionChannelSubscriptions;
            ...
            : base(id, world)
        {
            ...
            //this.positionChannelSubscriptions = new Dictionary<Item, IDisposable>();
            this.fiber = fiber;
        }
        ...
        protected override void OnItemUnsubscribed(Item item)
        {
            ...
            if (item.Type == (byte)ItemType.Bot) {
                ...
                if (positionChannelSubscriptions.ContainsKey(item))
                {
                    IDisposable msgRec = positionChannelSubscriptions[item];
                    this.positionChannelSubscriptions.Remove(item);
                    msgRec.Dispose();
                }
            }*/
        }
        ...
        public void SubscribedItem_OnItemPosition(ItemPositionMessage message)
        {
