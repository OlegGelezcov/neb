...
namespace Common
{
    ...
    public enum ReturnCode : short
    {
        ...
        InvalidRPCID = 135,
        GuildNotFound = 136,
        GuildMemberNotFound = 137,
        CreditsRemoveFromStoreError = 138,
        NotEnoughPvpPoints = 139,
        PvpPointsRemoveFromStoreError = 140,
        GuildPrivilegeNotEnough = 141,
        DepositedCreditsDontEnough = 142,
        WithdrawCreditsError = 143,
        DepositedPvpPointsDontEnough = 144,
        WithdrawPvpPointsError = 145,
