...
namespace Nebula.Inventory.Objects {
    public class PlanetMiningStationInventoryObject : IInventoryObject {

        public PlanetMiningStationInventoryObject() {
            this.binded = false;
            this.isNew = true;
        }

        public PlanetMiningStationInventoryObject(Hashtable hash) {
            ParseInfo(hash);
        }
        ...
        public InventoryObjectType Type {
            get {
                return InventoryObjectType.planet_mining_station;
            }
        }
