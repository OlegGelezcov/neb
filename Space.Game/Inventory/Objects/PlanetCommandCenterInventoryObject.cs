...
namespace Nebula.Inventory.Objects {
    public class PlanetCommandCenterInventoryObject : IInventoryObject {

        public PlanetCommandCenterInventoryObject() {
            this.binded = false;
            this.isNew = true;
        }

        public PlanetCommandCenterInventoryObject(Hashtable hash) {
            ParseInfo(hash);
        }
        public bool binded {
            get;
